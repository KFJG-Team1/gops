...
| 항목 | 값 | 상태 |
| --- | --- | --- |
| AWS account ID | `993099901407` | 확인됨 |
| Region | `ap-northeast-2` | 확인됨 |
| 현재 확인 IAM ARN | `arn:aws:iam::993099901407:user/heejun` | 확인됨 |
| S3 bucket | `gops-market-data-993099901407-ap-northeast-2-an` | 존재, `ap-northeast-2` |
| Secrets Manager | `dev/alpaca` | 존재 |
| Secret ARN | `arn:aws:secretsmanager:ap-northeast-2:993099901407:secret:dev/alpaca-Bg2lkp` | 값 출력 금지 |
...
| --- | --- | --- |
| market-data worker 공용 | `alfaka-dev-market-data-worker` | `993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-market-data-worker` |
| backend | `alfaka-dev-gops-backend` | `993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-gops-backend` |
| frontend | `alfaka-dev-gops-frontend` | `993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-gops-frontend` |
...
aws s3api get-bucket-location \
  --bucket gops-market-data-993099901407-ap-northeast-2-an
...
aws ecr get-login-password --region ap-northeast-2 \
  | docker login --username AWS --password-stdin 993099901407.dkr.ecr.ap-northeast-2.amazonaws.com

docker tag gops-s3-sink:latest \
  993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-market-data-worker:latest

docker tag gops-gops-backend:latest \
  993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-gops-backend:latest

docker tag gops-gops-frontend:latest \
  993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-gops-frontend:latest

docker push 993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-market-data-worker:latest
docker push 993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-gops-backend:latest
docker push 993099901407.dkr.ecr.ap-northeast-2.amazonaws.com/alfaka-dev-gops-frontend:latest
```
