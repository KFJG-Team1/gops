...
Current architecture and operating contracts. The root `README.md` stays short;
repo-wide Codex rules live in root `AGENTS.md`; subsystem source-of-truth docs live here.
