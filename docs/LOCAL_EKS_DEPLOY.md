...
RUN_CZARDAS_ASSET_MIGRATIONS=true \
DRY_RUN=true \
...
RUN_CZARDAS_ASSET_MIGRATIONS=true FORCE_SERVICES=agent-orchestrator AWS_PROFILE=gops-dev ./scripts/aws/deploy-dev-local.sh
