...
class MarketDataHardeningContractTest(unittest.TestCase):
    ...
    def test_feed_profiles_and_market_session_contract(self):
        ...
        self.assertEqual(pre_windows[0][1], datetime(2026, 6, 28, 20, 0, tzinfo=timezone.utc))
        self.assertEqual(pre_windows[0][2], datetime(2026, 6, 29, 0, 0, tzinfo=timezone.utc))
