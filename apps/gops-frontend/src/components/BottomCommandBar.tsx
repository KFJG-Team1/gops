import { CandlestickChart, GitCompareArrows, LogIn, Newspaper, SendHorizontal, Square, TrendingUp, UserCircle, X } from "lucide-react";
        ...
        const Icon = chip.kind === "candle"
          ...
          : chip.kind === "news"
            ...
            : chip.kind === "compare"
              ? GitCompareArrows
              : TrendingUp;
        const kindLabel = chip.kind === "candle"
          ? "캔들"
          : chip.kind === "news"
            ? "뉴스"
            : chip.kind === "compare"
