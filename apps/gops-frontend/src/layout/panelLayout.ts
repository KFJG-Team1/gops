...
export type PanelContentKind = "chart" | "company" | "news" | "indices" | "ontology" | "portfolio" | "trade";
...
export const insertablePanelKinds: PanelContentKind[] = ["indices", "company", "news", "ontology", "portfolio", "trade", "chart"];
