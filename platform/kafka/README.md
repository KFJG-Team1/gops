...
Czardas build requests use a PostgreSQL queue and never enter Kafka. The manual
symbol/interval build path is independent from interactive agent analysis.
