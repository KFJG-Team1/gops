...
- AWS CLI now authenticates as `arn:aws:iam::993099901407:user/heejun`.
...
- Existing EKS access entries include `arn:aws:iam::993099901407:user/boom` and `arn:aws:iam::993099901407:role/gops-github-actions-dev-deploy-role`, both associated with `AmazonEKSClusterAdminPolicy`.
...
- Alternative: allow `user/heejun` to assume `arn:aws:iam::993099901407:role/gops-github-actions-dev-deploy-role` and keep kubeconfig configured with that role ARN.
